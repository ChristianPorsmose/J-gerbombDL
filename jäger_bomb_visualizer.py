...
class JägerBombVisualizer:

    def __init__(self, save_dir):
        self.save_dir = save_dir

    def visualize_batch(self, images, batch_dict, predictions=None, epoch=0, is_train=True, max_imgs=4):
        """
        ...
        """
        save_dir = Path(self.save_dir) / "visualizations"
